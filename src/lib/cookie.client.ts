...
export function setClientCookie(key: string, value: string, days = 7) {
  ...
  // biome-ignore lint/suspicious/noDocumentCookie: standard way to set cookies synchrononously across all browsers
...
export function deleteClientCookie(key: string) {
  // biome-ignore lint/suspicious/noDocumentCookie: standard way to delete cookies synchrononously across all browsers
